...
import iodev.geom2.macros.CircleIntersec2Macros;
...
class CircleIntersec2
{
	...
	{
		var dstCount:Int = 0;
		CircleIntersec2Macros.circleLine(dstA.x, dstA.y, dstB.x, dstB.y, dstCount, lpos.x, lpos.y, lvec.x, lvec.y, cpos.x, cpos.y, cradius);
		return dstCount;
	}
	...
	{
		var dstCount:Int = 0;
		CircleIntersec2Macros.circleLine(dstA.x, dstA.y, dstB.x, dstB.y, dstCount, rpos.x, rpos.y, rvec.x, rvec.y, cpos.x, cpos.y, cradius);
		return dstCount;
	}
}