...
import iodev.geom2.macros.LineIntersec2Macros;
...
class LineIntersec2
{
	public static function lineLine( apos:Vec2, avec:Vec2, bpos:Vec2, bvec:Vec2 ) : Vec2
	{
		...
		LineIntersec2Macros.lineLine(dstx, dsty, apos.x, apos.y, avec.x, avec.y, bpos.x, bpos.y, bvec.x, bvec.y);
		return new Vec2(dstx, dsty);
	}
	
	public static function lineLineTo( dst:Vec2, apos:Vec2, avec:Vec2, bpos:Vec2, bvec:Vec2 ) : Void
	{
		LineIntersec2Macros.lineLine(dst.x, dst.y, apos.x, apos.y, avec.x, avec.y, bpos.x, bpos.y, bvec.x, bvec.y);
	}
	
	public static function lineRay( lpos:Vec2, lvec:Vec2, rpos:Vec2, rvec:Vec2 ) : Vec2
	{
		var dstx:Float, dsty:Float;
		LineIntersec2Macros.lineLine(dstx, dsty, lpos.x, lpos.y, lvec.x, lvec.y, rpos.x, rpos.y, rvec.x, rvec.y);
	...
	{
		LineIntersec2Macros.lineLine(dst.x, dst.y, lpos.x, lpos.y, lvec.x, lvec.y, rpos.x, rpos.y, rvec.x, rvec.y);
	...
	{
		var dstx:Float, dsty:Float;
		LineIntersec2Macros.lineLine(dstx, dsty, lpos.x, lpos.y, lvec.x, lvec.y, spos.x, spos.y, svec.x, svec.y);
	...
	{
		LineIntersec2Macros.lineLine(dst.x, dst.y, lpos.x, lpos.y, lvec.x, lvec.y, spos.x, spos.y, svec.x, svec.y);
	...
	{
		var dstx:Float, dsty:Float;
		LineIntersec2Macros.lineLine(dstx, dsty, rpos.x, rpos.y, rvec.x, rvec.y, spos.x, spos.y, svec.x, svec.y);
		if (SpaceTest2Macros.isPointInRaySpace(dstx, dsty, rpos.x, rpos.y, rvec.x, rvec.y)
	...
	{
		LineIntersec2Macros.lineLine(dst.x, dst.y, rpos.x, rpos.y, rvec.x, rvec.y, spos.x, spos.y, svec.x, svec.y);
		return (
